...
ls $TMP_PATH/images/ | sed -e "s/\.png$//" | xargs -I {} -P $PROCESS_COUNT convert $TMP_PATH/images/{}.png -resize 322x433! -sampling-factor 1:1:1 -define jpeg:dct-method=float -quality 100 $PWD/images/picture/card/{}.jpg
rm -rf $TMP_PATH
